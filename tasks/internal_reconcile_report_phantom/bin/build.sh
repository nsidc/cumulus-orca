...
cp ../package/awslambda-psycopg2/psycopg2-3.9/* build11/psycopg2/
...
cp -r schemas/ build11/
check_returncode $? "ERROR: Failed to copy schema files to build directory."

## Create the zip archive
cd build11
trap 'cd -;deactivate_and_delete_venv;rm -rf build11;' EXIT
run_and_check_returncode "zip -qr ../internal_reconcile_report_phantom.zip ."
