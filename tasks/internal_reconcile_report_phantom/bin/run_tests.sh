...
## DESCRIPTION
## -----------------------------------------------------------------------------
## Tests the lambda (task) for internal_reconcile_report_phantom using unit tests.
##
##
## USAGE
## -----------------------------------------------------------------------------
...
coverage run --source internal_reconcile_report_phantom -m pytest --ignore=build
