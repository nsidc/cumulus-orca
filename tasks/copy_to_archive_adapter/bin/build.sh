...
run_and_check_returncode "mkdir build3"
trap 'rm -rf build3' EXIT

run_and_check_returncode "create_and_activate_venv"
trap 'deactivate_and_delete_venv;rm -rf build3;' EXIT
run_and_check_returncode "pip install -q --upgrade pip --trusted-host pypi.org --trusted-host files.pythonhosted.org"

## Install the requirements
pip install -q -t build3 -r requirements.txt --trusted-host pypi.org --trusted-host files.pythonhosted.org
...
cd build3
trap 'cd -;deactivate_and_delete_venv;rm -rf build3;' EXIT
