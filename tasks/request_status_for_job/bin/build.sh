...
cp ../package/awslambda-psycopg2/psycopg2-3.9/* build21/psycopg2/
...
cp -r schemas/ build21/
check_returncode $? "ERROR: Failed to copy schema files to build directory."

## Create the zip archive
cd build21
trap 'cd -;deactivate_and_delete_venv;rm -rf build21;' EXIT
run_and_check_returncode "zip -qr ../request_status_for_job.zip ."
