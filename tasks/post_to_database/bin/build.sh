...
cp ../package/awslambda-psycopg2/psycopg2-3.9/* build17/psycopg2/
...
cp -r schemas/ build17/
check_returncode $? "ERROR: Failed to copy schema files to build directory."

## Create the zip archive
cd build17
trap 'cd -;deactivate_and_delete_venv;rm -rf build17;' EXIT
