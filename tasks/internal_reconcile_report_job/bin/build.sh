...
## DESCRIPTION
## -----------------------------------------------------------------------------
## Builds the lambda (task) zip file for internal_reconcile_report_job.
##
##
## USAGE
## -----------------------------------------------------------------------------
## bin/build.sh
##
## This must be called from the (root) lambda directory /tasks/internal_reconcile_report_job
## =============================================================================
...
cp ../package/awslambda-psycopg2/psycopg2-3.9/* build8/psycopg2/
...
cd build8
trap 'cd -;deactivate_and_delete_venv;rm -rf build8;' EXIT
run_and_check_returncode "zip -qr ../internal_reconcile_report_job.zip ."
