...
## DESCRIPTION
## -----------------------------------------------------------------------------
## Builds the lambda (task) zip file for internal_reconcile_report_mismatch.
##
##
## USAGE
## -----------------------------------------------------------------------------
## bin/build.sh
##
## This must be called from the (root) lambda directory /tasks/internal_reconcile_report_mismatch
## =============================================================================
...
cp ../package/awslambda-psycopg2/psycopg2-3.9/* build9/psycopg2/
...
cd build9
trap 'cd -;deactivate_and_delete_venv;rm -rf build9;' EXIT
run_and_check_returncode "zip -qr ../internal_reconcile_report_mismatch.zip ."
