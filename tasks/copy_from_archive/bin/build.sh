...
cp ../package/awslambda-psycopg2/psycopg2-3.9/* build1/psycopg2/
...
cd build1
trap 'cd -;deactivate_and_delete_venv;rm -rf build1;' EXIT
run_and_check_returncode "zip -qr ../copy_from_archive.zip ."
