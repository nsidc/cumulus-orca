...
## DESCRIPTION
## -----------------------------------------------------------------------------
## Builds the lambda (task) zip file for get_current_archive_list.
##
##
## USAGE
## -----------------------------------------------------------------------------
...
cp ../package/awslambda-psycopg2/psycopg2-3.9/* build7/psycopg2/
...
cd build7
trap 'cd -;deactivate_and_delete_venv;rm -rf build7;' EXIT
run_and_check_returncode "zip -qr ../get_current_archive_list.zip ."
