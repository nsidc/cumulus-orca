...
## DESCRIPTION
## -----------------------------------------------------------------------------
## Builds the lambda (task) zip file for delete_old_reconcile_jobs.
##
##
## USAGE
## -----------------------------------------------------------------------------
## bin/build.sh
##
## This must be called from the (root) lambda directory /tasks/delete_old_reconcile_jobs
## =============================================================================
...
cp ../package/awslambda-psycopg2/psycopg2-3.9/* build5/psycopg2/
...
cd build5
trap 'cd -;deactivate_and_delete_venv;rm -rf build5;' EXIT
