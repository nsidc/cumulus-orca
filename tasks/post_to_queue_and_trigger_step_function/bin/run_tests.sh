...
## DESCRIPTION
## -----------------------------------------------------------------------------
## Tests the lambda (task) for post_to_queue_and_trigger_step_function using unit tests.
##
##
## USAGE
## -----------------------------------------------------------------------------
...
coverage run --source post_to_queue_and_trigger_step_function -m pytest --ignore=build
